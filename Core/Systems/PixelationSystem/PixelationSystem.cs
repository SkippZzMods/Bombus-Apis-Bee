...
namespace BombusApisBee.Core.Systems.PixelationSystem
{
    public class PixelationSystem : ModSystem
    {
        ...
        public override void PostSetupContent()
        {
            ...
            GetInstance<PixelationSystem>().RegisterScreenTarget("UnderTiles", RenderLayer.UnderTiles);

            GetInstance<PixelationSystem>().RegisterScreenTarget("UnderNPCs", RenderLayer.UnderNPCs);

            GetInstance<PixelationSystem>().RegisterScreenTarget("UnderProjectiles", RenderLayer.UnderProjectiles);

            GetInstance<PixelationSystem>().RegisterScreenTarget("OverPlayers", RenderLayer.OverPlayers);

            GetInstance<PixelationSystem>().RegisterScreenTarget("OverWiresUI", RenderLayer.OverWiresUI);

            GetInstance<PixelationSystem>().RegisterScreenTarget("Dusts", RenderLayer.Dusts);
        }
