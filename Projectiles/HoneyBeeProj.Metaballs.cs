...
{
    public class HoneyBeeProj_Metaballs : MetaballActor
    {
        public override bool Active => Main.projectile.Any(Main.dust.Any(x => x.active && x.type == ModContent.DustType<HoneyBeeDust>()));
        ...
        public override void DrawShapes(SpriteBatch spriteBatch)
        {
            ...
            var honeyDust = Main.dust.Where(n => n.active && n.type == ModContent.DustType<HoneyBeeDust>());
