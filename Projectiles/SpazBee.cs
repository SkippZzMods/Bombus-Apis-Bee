...
namespace BombusApisBee.Projectiles
{
    public class SpazBee : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dustType = Utils.NextBool(Main.rand, 3) ? DustID.CursedTorch : DustID.TerraBlade;
                        ...
                        {
                            {
                                if (Main.myPlayer == Projectile.owner)
                                {
                                    ...
                                    shootToX *= distance * 4;
                                    shootToY *= distance * 4;
                                    int proj = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center.X, Projectile.Center.Y, shootToX, shootToY, ProjectileID.CursedFlameFriendly, (int)(Projectile.damage * 0.75f), Projectile.knockBack, Main.myPlayer);
