namespace BombusApisBee.Content.Corruption.Items.CursedHoneycomb
{
    public class CursedEye : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.velocity = (Projectile.velocity * 20f + (targetCenter - Projectile.Center).SafeNormalize(Vector2.UnitX) * 14f) / 21f;
            }

            if (Main.rand.NextBool())
                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), null, 0, new Color(97, 130, 30), 0.3f);
        }
