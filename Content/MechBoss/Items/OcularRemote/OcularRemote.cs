...
namespace BombusApisBee.Content.MechBoss.Items.OcularRemote
{
    public class OcularRemote : BeeDamageItem
    {
        ...
        public override void SafeSetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ProjectileType<SpazHoneycomb>();
            Item.shootSpeed = 13;
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, Main.MouseWorld, Main.rand.NextVector2Circular(5f, 5f), ProjectileType<RetinaHoneycomb>(), damage, knockback, player.whoAmI);
            return false;
        }
    }
}