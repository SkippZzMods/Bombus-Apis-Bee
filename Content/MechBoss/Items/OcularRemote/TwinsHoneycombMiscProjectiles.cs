...
namespace BombusApisBee.Content.MechBoss.Items.OcularRemote
{
    public class CursedFlameball : BeeProjectile, IDrawPrimitive_
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(0.5f, 0.5f), 0, new Color(98, 205, 123), 0.4f);

            Dust.NewDustPerfect(Projectile.Center, DustType<GlowFastDecelerate>(), null, 0, new Color(231, 215, 157), 0.35f);
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ProjectileType<CursedExplosion>(), Projectile.damage, 0f, Projectile.owner, 65);

            for (int i = 0; i < 25; i++)
            {
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(3f, 3f), 0, new Color(98, 205, 123), 0.4f);

                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(4.5f, 4.5f), 0, new Color(231, 215, 157), 0.3f);
            }
        }
    ...
    public class SpazBee : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center, DustType<Glow>(), Vector2.Zero, 0, new Color(98, 205, 123), 0.35f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ProjectileType<CursedExplosion>(), Projectile.damage, 0f, Projectile.owner, 25);

            for (int i = 0; i < 15; i++)
            {
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(1f, 1f), 0, new Color(98, 205, 123), 0.3f);

                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(1.5f, 1.5f), 0, new Color(231, 215, 157), 0.2f);
            }
        }
    }
}
