namespace BombusApisBee.Content.Jungle.Items.QueensCharge
{
        ...
        public override void PreUpdateMovement()
        {
            ...
            if (DashTimer > 0)
            {
                if (DashTimer % 10 == 0)
                {
                    for (int i = 0; i < 2; i++)
                    {
                        Projectile.NewProjectileDirect(Player.GetSource_Accessory(new Item(ItemType<TheQueensCharge>())), Player.Center, Vector2.One.RotatedByRandom(6.28f) * 3.5f, Player.beeType(),
                    ...
                    for (int i = 0; i < Repeats; ++i)
                    {
                        ...
                        Dust dust3 = Dust.NewDustPerfect(Player.Center, DustID.Honey2, null, 0, default, 1.1f);
