...
namespace BombusApisBee.Content.Jungle.Items.WaspYoyo
{
    public class TheWaspNest : BeeDamageItem
    {
        ...
        public override void SafeSetDefaults()
        {
            ...
            Item.shoot = ProjectileType<TheWaspNestProjectile>();
            honeyCost = 2;
        }
        public override void AddRecipes()
        {
            CreateRecipe(1).AddIngredient(ItemID.ChlorophyteBar, 15).AddIngredient(ItemType<Ambrosia.Ambrosia>()).AddIngredient(ItemType<PollenItem>(), 25).AddTile(TileID.MythrilAnvil).Register();
        }
