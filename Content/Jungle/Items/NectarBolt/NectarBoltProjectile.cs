...
namespace BombusApisBee.Content.Jungle.Items.NectarBolt
{
    public class NectarBoltProjectile : BeeProjectile, IDrawPrimitive_
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center + Projectile.rotation.ToRotationVector2() * 5f, DustType<Dusts.GlowFastDecelerate>(), Vector2.Zero, Scale: 0.35f, newColor: new Color(255, 255, 150));

            Dust.NewDustPerfect(Projectile.Center + Projectile.rotation.ToRotationVector2() * -5f, DustType<Dusts.GlowFastDecelerate>(), Vector2.Zero, Scale: 0.35f, newColor: new Color(255, 191, 73));
        }
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 20; i++)
            {
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(3f, 3f), 0, new Color(255, 191, 73), 0.3f);
            }
        }
            ...
            if (Main.myPlayer == Projectile.owner)
                for (int i = 0; i < Main.rand.Next(1, 3); i++)
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Main.rand.NextVector2CircularEdge(9f, 9f),
                        ProjectileType<NectarBoltHoming>(), (int)(Projectile.damage * 0.5f), Projectile.knockBack * 0.65f, Projectile.owner);
                }

            Projectile.CircleDust(35, DustType<Dusts.GlowFastDecelerate>(), 2.5f, 0, new Color(255, 191, 73), 0.35f);
        }
    }
    ...
    class NectarBoltHoming : BeeProjectile, IDrawPrimitive_
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center + Projectile.rotation.ToRotationVector2() * 3f, DustType<Dusts.GlowFastDecelerate>(), Vector2.Zero, Scale: 0.35f, newColor: new Color(255, 255, 150));
            ...
            {
                Projectile.velocity = (Projectile.velocity * 20f + (targetCenter - Projectile.Center).SafeNormalize(Vector2.UnitX) * 9f) / 21f;
            }
