...
namespace BombusApisBee.Content.Jungle.Items.BladeOfAculeus
{
    public class AculeusBladeStinger : BeeProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 10; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<StingerDust>(), -Projectile.oldVelocity.RotatedByRandom(0.6f) * Main.rand.NextFloat(0.75f), Main.rand.Next(50, 255), default, 1.5f).noGravity = true;
                ...
                Dust.NewDustPerfect(Projectile.Center, DustType<Glow>(), -Projectile.oldVelocity.RotatedByRandom(0.4f) * Main.rand.NextFloat(0.15f), 0, new Color(50, Main.rand.Next(150, 255), 50), Main.rand.NextFloat(0.4f, 0.6f));
            }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<StingerDust>(), -Projectile.velocity.RotatedByRandom(0.6f) * Main.rand.NextFloat(1f), Main.rand.Next(50, 255), default, 1.5f).noGravity = true;
                ...
                Dust.NewDustPerfect(Projectile.Center, DustType<Glow>(), -Projectile.velocity.RotatedByRandom(0.4f) * Main.rand.NextFloat(0.25f), 0, new Color(50, Main.rand.Next(150, 255), 50), Main.rand.NextFloat(0.4f, 0.6f));
            }
