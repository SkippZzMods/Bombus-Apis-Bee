...
{
    public class ChlorophyteBee : CommonBeeProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2Circular(12f, 12f), ProjectileType<ChloroEnergy>(), Projectile.damage / 2, 1f, Projectile.owner);
        ...
        public override void SafeAI()
        {
            if (Main.rand.NextBool(3))
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(2f, 2f), DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(1f, 1f), 0, new Color(117, 216, 19, 0), 0.3f);
        }
    ...
    public class ChloroEnergy : BeeProjectile, IDrawPrimitive_
    {
        ...
        public override void AI()
        {
            ...
            if (foundTarget && Projectile.timeLeft < 345)
                Projectile.velocity = (Projectile.velocity * 20f + (targetCenter - Projectile.Center).SafeNormalize(Vector2.UnitX) * 12f) / 21f;

            Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.Glow>(), Vector2.Zero, 0,
