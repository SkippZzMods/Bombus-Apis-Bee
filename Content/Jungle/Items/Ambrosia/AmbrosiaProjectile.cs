    ...
    public class AmbrosiaProjectile : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(3))
                Dust.NewDustPerfect(Projectile.Center, DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(1f, 1f), 0, new Color(255, 191, 73), 0.35f);
        }

        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            if (Main.rand.NextBool(5))
                Projectile.NewProjectile(Projectile.GetSource_OnHit(target), Projectile.Center, Vector2.Zero, ProjectileType<AmbrosiaExplosion>(), Projectile.damage / 2, 0, Projectile.owner);
