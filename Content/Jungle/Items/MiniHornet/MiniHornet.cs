...
namespace BombusApisBee.Content.Jungle.Items.MiniHornet
{
    public class MiniHornet : BeeDamageItem
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.Minishark, 1).AddIngredient(ItemID.Stinger, 5).AddIngredient(ItemID.Vine, 5).AddIngredient(ItemType<PollenItem>(), 15).AddTile(TileID.Anvils).Register();
        }
