...
namespace BombusApisBee.Content.Jungle.Items.TriTipStinger
{
    ...
    {
        public override bool Active => Main.dust.Any(x => x.active && x.type == DustType<TriTipStingerDust>());
        ...
        public override void DrawShapes(SpriteBatch spriteBatch)
        {
            ...
            var poisonDust = Main.dust.Where(n => n.active && n.type == DustType<TriTipStingerDust>());
        ...
        public override bool PostDraw(SpriteBatch spriteBatch, Texture2D target)
        {
            ...
            effect.Parameters["distort"].SetValue(Request<Texture2D>("BombusApisBee/ExtraTextures/ShaderNoiseLooping").Value);
