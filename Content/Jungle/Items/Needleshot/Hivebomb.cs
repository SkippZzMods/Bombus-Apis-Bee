    ...
    public class Hivebomb : BeeProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2Circular(3.5f, 3.5f), ProjectileType<HoneySmoke>(), Projectile.damage / 2, 0f, Projectile.owner);
                }
            ...
            for (int i = 0; i < 15; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<HoneyDust>(), Main.rand.NextVector2Circular(2f, 2f), Main.rand.Next(50, 150), default, 1.25f).noGravity = true;
                ...
                Dust.NewDustPerfect(Projectile.Center, DustType<HoneyDust>(), Main.rand.NextVector2Circular(6f, 6f), Main.rand.Next(50, 150), default, 1.25f).noGravity = true;
