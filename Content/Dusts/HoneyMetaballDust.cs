...
namespace BombusApisBee.Content.Dusts
{
    public class HoneyDustTransparent_Metaballs : MetaballActor
    {
        ...
        public override void DrawShapes(SpriteBatch spriteBatch)
        {
            ...
            foreach (Dust dust in honeyDust)
            {
                ...
                spriteBatch.Draw(ModContent.Request<Texture2D>("BombusApisBee/Content/Jungle/Items/HiveBandAccessory/BandHoneyDust").Value, (dust.position - Main.screenPosition) / 2, null, Color.White * 0.85f, 0f, Vector2.One * 256f, dust.scale / 64f, SpriteEffects.None, 0);
            }
    ...
    public class HoneyDust_Metaballs : MetaballActor
    {
        ...
        public override void DrawShapes(SpriteBatch spriteBatch)
        {
            ...
            {
                borderNoise.Parameters["offset"].SetValue((float)Main.time / 1000f + dust.rotation);
                spriteBatch.Draw(ModContent.Request<Texture2D>("BombusApisBee/Content/Jungle/Items/HiveBandAccessory/BandHoneyDust").Value, (dust.position - Main.screenPosition) / 2, null, Color.White, 0f, Vector2.One * 256f, dust.scale / 64f, SpriteEffects.None, 0);
            }
