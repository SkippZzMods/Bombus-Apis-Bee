...
namespace BombusApisBee.Content.Dusts.Pixelized
{
    public class PixelSmokeColor : ModDust
    {
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            Color color = Color.Lerp(dust.color, fadeColor ?? Color.Black, EaseFunction.EaseQuinticInOut.Ease(1f - lerper));

            Texture2D tex = Request<Texture2D>("BombusApisBee/ExtraTextures/SmokeTransparent_" + variant).Value;
