namespace BombusApisBee.Content.Dusts
{
    public class SmokeDustAlt : ModDust
    {
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            Texture2D tex = ModContent.Request<Texture2D>("BombusApisBee/Content/Dusts/SmokeDustAlt").Value;
    ...
    {
        public override string Texture => "BombusApisBee/Content/Dusts/SmokeDust";
        public override bool Update(Dust dust)
        {
