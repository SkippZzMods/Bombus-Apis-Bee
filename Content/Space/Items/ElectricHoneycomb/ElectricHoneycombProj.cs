...
namespace BombusApisBee.Content.Space.Items.ElectricHoneycomb
{
    public class ElectricHoneycombProj : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(1f, 1f) + Projectile.ai[0].ToRotationVector2() * MathHelper.Lerp(55f, 5f, 1f - Projectile.timeLeft / 120f), DustType<Dusts.GlowFastDecelerate>(), Vector2.Zero, Scale: 0.4f, newColor: new Color(233, 245, 255));
            ...
            if (Main.rand.NextBool(60) && Main.player[Projectile.owner].UseBeeResource((Main.player[Projectile.owner].HeldItem.ModItem as BeeDamageItem).honeyCost - 4))
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2CircularEdge(3f, 3f), ProjectileType<ElectricHoneycombLightning>(), Projectile.damage * 3 / 4, 0f, Projectile.owner);
            }
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Main.rand.NextVector2Circular(3f, 3f), ProjectileType<ElectricBee>(), Projectile.damage * 2 / 3, 0f, Projectile.owner);
                    Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center + new Vector2(Main.rand.Next(-200, 200), -900), Vector2.UnitY * 10f, ProjectileType<ElectricHoneycombLightning>(), Projectile.damage * 3 / 4, 5f, Projectile.owner);
                }
            ...
            for (int i = 0; i < 25; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(3f, 3f), 0, new Color(233, 245, 255), 0.85f);

                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.Glow>(), Main.rand.NextVector2Circular(3.5f, 3.5f), 0, new Color(110, 220, 255), 0.65f);

                for (int k = 0; k < 4; k++)
                {
                    var vel = Vector2.One.RotatedBy(Main.rand.NextFloat(6.28f)) * Main.rand.NextFloat(2f);
                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.Gas>(), vel, 0, new Color(255, 255, 255) * 0.1f, Main.rand.NextFloat(4.5f, 6.5f));

                    vel = Vector2.One.RotatedBy(Main.rand.NextFloat(6.28f)) * Main.rand.NextFloat(2f);
                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.Gas>(), vel, 0, new Color(233, 245, 255) * 0.1f, Main.rand.NextFloat(4.5f, 6.5f));
                }
            }
        ...
        {
            target.AddBuff(BuffType<Electrocuted>(), Main.rand.Next(new int[] { 120, 240, 360 }));
        }
    ...
    class ElectricHoneycombLightning : BeeProjectile, IDrawPrimitive_
    {
        ...
        public override void AI()
        {
            if (Projectile.timeLeft == 150)
                for (int i = 0; i < 25; i++)
                {
                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(3f, 3f), 0, new Color(233, 245, 255), 0.55f);

                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(3.5f, 3.5f), 0, new Color(110, 220, 255), 0.45f);
                }
            ...
            if (Main.rand.NextBool())
                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.Glow>(), (-Projectile.velocity * 0.45f).RotatedByRandom(0.45f), 50, new Color(233, 245, 255), 0.6f);
            else
                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.Glow>(), (-Projectile.velocity * 0.45f).RotatedByRandom(0.45f), 50, new Color(110, 220, 255), 0.45f);

            if (Projectile.timeLeft == 1 && !collided)
            {
                for (int i = 0; i < 25; i++)
                {
                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Projectile.oldVelocity.RotatedByRandom(0.45f) * -Main.rand.NextFloat(0.55f), 0, new Color(233, 245, 255), 0.55f);

                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Projectile.oldVelocity.RotatedByRandom(0.45f) * -Main.rand.NextFloat(0.65f), 0, new Color(110, 220, 255), 0.45f);
                ...
                for (int i = 0; i < 30; i++)
                {
                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(5f, 5f), 0, new Color(233, 245, 255), 0.55f);

                    Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(6f, 6f), 0, new Color(110, 220, 255), 0.45f);
                }
                collided = true;
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            for (int i = 0; i < 25; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), oldVelocity.RotatedByRandom(0.35f) * -Main.rand.NextFloat(0.35f), 0, new Color(233, 245, 255), 0.55f);

                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), oldVelocity.RotatedByRandom(0.35f) * -Main.rand.NextFloat(0.45f), 0, new Color(110, 220, 255), 0.45f);
    ...
    public class ElectricBee : BaseBeeProjectile
    {
        ...
        {
            target.AddBuff(BuffType<Electrocuted>(), Main.rand.Next(new int[] { 60, 120, 180 }));
        }
        public override void SafeAI()
        {
            if (Main.rand.NextBool(10))
                for (int i = 0; i < 15; i++)
                {
                    Dust.NewDustPerfect(Projectile.Center + (Giant ? Main.rand.NextVector2CircularEdge(20.5f, 20.5f) : Main.rand.NextVector2CircularEdge(15.5f, 15.5f)), DustType<Dusts.GlowFastDecelerate>(), Vector2.Zero, 0, new Color(110, 220, 255), 0.2f);
                }
        }
    }
}
