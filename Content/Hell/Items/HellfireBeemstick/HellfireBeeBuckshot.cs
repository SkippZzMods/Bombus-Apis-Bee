...
namespace BombusApisBee.Content.Hell.Items.HellfireBeemstick
{
    public class HellfireBeeBuckshot : BeeProjectile, IDrawPrimitive_
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(5))
                Dust.NewDustPerfect(Projectile.Center, DustType<Dusts.GlowFastDecelerate>(), Main.rand.NextVector2Circular(0.5f, 0.5f), 0,
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                Projectile.NewProjectileDirect(Projectile.GetSource_Death(), Projectile.Center, initVelo * 0.5f, ProjectileType<HellfireBee>(), damage, knockBack, Projectile.owner);
            }
        }
    ...
    public class HellfireBeemstickSlug : BeeProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<HellfireSlugExplosionDust>(), Main.rand.NextVector2Circular(6.5f, 6.5f) + -Vector2.UnitY * 2f, Main.rand.Next(30), default, Main.rand.NextFloat(0.05f, 0.1f)).rotation = Main.rand.NextFloat(6.28f);
            }
