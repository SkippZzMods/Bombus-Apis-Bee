    ...
    public class NectarSmoke : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(7))
                Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustType<GlowFastDecelerate>(), 0, 0, 0, new Color(214, 158, 79), MathHelper.Lerp(1f, 0f, Projectile.alpha / 255f));
        }
