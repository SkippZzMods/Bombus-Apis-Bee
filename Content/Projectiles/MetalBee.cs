    ...
    public class MetalBee : CommonBeeProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
                Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center, Vector2.Zero, ProjectileType<MetalBeeExplosion>(), Projectile.damage / 2, 0f, Projectile.owner, Giant ? 30 : 15);
        }
        public override void SafeAI()
        {
            if (Main.rand.NextBool(3))
                Dust.NewDustPerfect(Projectile.Center + Projectile.velocity, DustType<GlowFastDecelerate>(), default, 55,
