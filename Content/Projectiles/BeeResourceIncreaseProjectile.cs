namespace BombusApisBee.Content.Projectiles
{
    public class BeeResourceIncreaseProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(2f, 2f), DustType<HoneyMetaballDust>(), -Projectile.velocity.RotatedByRandom(0.2f) * 0.15f, 0, default, 0.75f).noGravity = true;
                Dust.NewDustPerfect(Projectile.Center - Projectile.velocity + Main.rand.NextVector2Circular(2f, 2f), DustType<HoneyMetaballDust>(), -Projectile.velocity.RotatedByRandom(0.2f) * 0.15f, 0, default, 0.75f).noGravity = true;
            }
            else
