...
namespace BombusApisBee.Content.Projectiles
{
    class HomingNectar : BeeProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(2.5f, 2.5f), DustType<GlowFastDecelerate>(), null, Scale: 0.35f, newColor: new Color(214, 158, 79));
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < 25; i++)
            {
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(5f, 5f), DustType<GlowFastDecelerate>(), Main.rand.NextVector2Circular(2.5f, 2.5f), 0, new Color(255, 191, 73), 0.3f);
            }
        }
