    ...
    public class SkeletalStinger : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 1f && Main.rand.NextBool(3))
                Dust.NewDustPerfect(Projectile.Center, DustType<GlowFastDecelerate>(), Vector2.One.RotatedByRandom(6.28f), 25, new Color(200, 45, 20), Main.rand.NextFloat(0.2f, 0.4f));
