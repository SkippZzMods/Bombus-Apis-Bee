    ...
    public class SquireBee : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.dead || !player.active)
                player.ClearBuff(BuffType<SquireBuff>());

            if (player.HasBuff(BuffType<SquireBuff>()))
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<HoneyDust>(), Projectile.velocity.X * 0.25f, Projectile.velocity.Y * 0.25f, 150, default, 0.7f);
            }
