...
namespace BombusApisBee.Content.Forest.Items.BeeSniperArmor
{
    ...
    public class BeeSniperGoggles : BeeKeeperItem
    {
        ...
        {
            return body.type == ItemType<BeeSniperArmor>() && legs.type == ItemType<BeeSniperLeggings>();
        }
    ...
    class MarkedGlobalNPC : GlobalNPC
    {
        ...
        public override void PostDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            if (marked)
            {
                Texture2D tex = Request<Texture2D>("BombusApisBee/ExtraTextures/BeeSniperMarked").Value;
                Texture2D texGlow = Request<Texture2D>("BombusApisBee/ExtraTextures/BeeSniperMarked_Glow").Value;
                Texture2D texGlowAlt = Request<Texture2D>("BombusApisBee/ExtraTextures/BeeSniperMarked_GlowAlt").Value;
