        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[1] == 3f)
            {
                for (int i = 0; i < 12; i++)
                {
                    ...
                    vector3 += -Vector2.UnitY.RotatedBy((double)(i * 3.1415927f / 6f), default) * new Vector2(8f, 16f);
                    vector3 = vector3.RotatedBy((double)(Projectile.rotation - 1.5707964f), default);
                    int num9 = Dust.NewDust(Projectile.Center, 0, 0, DustID.Poisoned, 0f, 0f, 150, default, 1f);
