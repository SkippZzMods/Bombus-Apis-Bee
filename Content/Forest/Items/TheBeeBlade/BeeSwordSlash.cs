    ...
    public class BeeSwordSlash : BeeProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                ...
                Main.spriteBatch.Draw(Texture, drawPosition, null, Projectile.GetAlpha(drawColor), Projectile.oldRot[i], Texture.Size() * 0.5f, 1.1f, 0, 0f);
            }
            return false;
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < Repeats; ++i)
            {
                ...
                Dust dust3 = Dust.NewDustPerfect(target.Center, DustID.Honey2, null, 0, default, 1.1f);
