...
namespace BombusApisBee.Content.Forest.Items.HoneyFlareGun
{
    public class HoneyFlareGun : BeekeeperWeapon
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.FlareGun, 1).AddIngredient(ItemID.BottledHoney, 5).AddIngredient(ModContent.ItemType<PollenItem>(), 20).AddTile(TileID.Anvils).Register();
        }
