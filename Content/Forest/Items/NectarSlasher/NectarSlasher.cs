...
namespace BombusApisBee.Content.Forest.Items.NectarSlasher
{
    public class NectarSlasher : BeeDamageItem
    {
        ...
        private int combo = 0;
        public override bool SafeCanUseItem(Player player) => player.ownedProjectileCounts[ProjectileType<NectarSlasherHoldout>()] <= 0;
        ...
        public override void SafeSetDefaults()
        {
            ...
            Item.knockBack = 2.5f;
            Item.shootSpeed = 5f;
            Item.shoot = ProjectileType<NectarSlasherHoldout>();
