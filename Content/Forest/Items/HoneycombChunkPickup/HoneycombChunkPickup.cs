...
namespace BombusApisBee.Content.Forest.Items.HoneycombChunkPickup
{
    ...
    {
        public string TextureString = "BombusApisBee/Content/Forest/Items/HoneycombChunkPickup/HoneycombChunkPickup_1";
        public override ModItem Clone(Item newEntity)
        {
            ModItem clone = base.Clone(newEntity);
            (clone as HoneycombChunkPickup).TextureString = TextureString;
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            Texture2D tex = Request<Texture2D>(TextureString).Value;
