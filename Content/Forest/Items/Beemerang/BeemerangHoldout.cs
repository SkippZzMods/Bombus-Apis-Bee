...
namespace BombusApisBee.Content.Forest.Items.Beemerang
{
    public class BeemerangHoldout : ModProjectile
    {
        ...
        {
            modifiers.SourceDamage *= MathHelper.Lerp(1f, 3f, chargeTimer / (float)maxCharge);
            modifiers.Knockback *= MathHelper.Lerp(1f, 1.5f, chargeTimer / (float)maxCharge);
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < Repeats; ++i)
            {
                ...
                Dust dust3 = Dust.NewDustPerfect(target.Center, DustType<Dusts.HoneyDust>(), null, 0, default, 1.1f);
                dust3.velocity = angle2.ToRotationVector2() * 1.75f;
