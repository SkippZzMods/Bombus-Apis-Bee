...
namespace BombusApisBee.Content.Forest.Items.BeefinTuna
{
    public class BeeFishBubble : BeeProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 25; i++)
            {
                Dust.NewDustPerfect(Projectile.Center, DustType<HoneyDust>(), Main.rand.NextVector2Circular(2f, 2f), Main.rand.Next(80), Scale: Main.rand.NextFloat(0.8f, 1.25f)).noGravity = true;
            }
        }
    }
}
