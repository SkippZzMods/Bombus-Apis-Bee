...
{
    public class StoneHoneycomb : BeekeeperWeapon
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ItemID.StoneBlock, 35).AddIngredient(ItemType<PollenItem>(), 10).AddTile(TileID.WorkBenches).Register();
        }
    }
}