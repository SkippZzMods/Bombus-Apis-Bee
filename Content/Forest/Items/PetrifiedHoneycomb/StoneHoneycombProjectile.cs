...
namespace BombusApisBee.Content.Forest.Items.PetrifiedHoneycomb
{
    ...
    {
        public override string Texture => "BombusApisBee/Content/Forest/Items/PetrifiedHoneycomb/StoneHoneycomb";
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(15))
                Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustType<HoneyDust>());
