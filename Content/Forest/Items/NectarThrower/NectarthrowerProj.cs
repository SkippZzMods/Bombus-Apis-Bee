namespace BombusApisBee.Content.Forest.Items.NectarThrower
{
    public class NectarthrowerProj : BeeProjectile
    {
        ...
        {
            Texture2D tex = Request<Texture2D>("BombusApisBee/ExtraTextures/FlamethrowerTexture").Value;
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(5))
            {
                ...
                Dust.NewDustPerfect(Projectile.Center + Main.rand.NextVector2Circular(lerper, lerper), DustType<GlowFastDecelerate>(), null, Projectile.alpha, Color.Lerp(new Color(214, 158, 79), new Color(163, 97, 66), 1f - Projectile.timeLeft / 100f), 0.4f);
            }
        }
