using BombusApisBee.Content.Forest.Items.Beenigun;
using BombusApisBee.Content.Forest.Items.HoneyBeeItem;
using BombusApisBee.Content.Forest.Items.NectarSlasher;
using BombusApisBee.Content.Forest.Items.NectarThrower;
using BombusApisBee.Content.Forest.Items.TraitorSaxophone;
using BombusApisBee.Content.Jungle.Items.HoneyLocket;
using BombusApisBee.Content.Jungle.Items.Wasparang;
using Terraria.GameContent.Bestiary;
using Terraria.GameContent.ItemDropRules;
using Terraria.GameContent.Personalities;
using Terraria.Localization;

namespace BombusApisBee.Content.Forest.NPCs
{
    [AutoloadHead]
    public class TheTraitorBee : ModNPC
    {
        ...
        public override void AddShops()
        {
            NPCShop shop = new NPCShop(Type, "Shop")
                ...
                .Add(ItemType<TheTraitorsSaxophone>())
                .Add(ItemType<NectarSlasher>())
                .Add(ItemID.BeeKeeper)
                .Add(ItemID.BeesKnees)
                .Add(ItemID.BeeGun)
                .Add(ItemType<Wasparang>(), Condition.Hardmode)
                .Add(ItemType<Nectarthrower>(), Condition.Hardmode)
                .Add(ItemType<HoneyLocket>(), Condition.Hardmode)
                .Add(ItemType<HoneyBeeItem>(), Condition.DownedMechBossAny)
                .Add(ItemType<BeeInyGun>(), Condition.DownedGolem);
